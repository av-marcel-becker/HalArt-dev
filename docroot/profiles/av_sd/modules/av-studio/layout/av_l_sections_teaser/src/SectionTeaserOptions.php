<?php
namespace Drupal\av_l_sections_teaser;
...
use Drupal\av_l_sections_teaser\OptionsSetup;

class SectionTeaserOptions extends LayoutDefault implements PluginFormInterface 
   {
