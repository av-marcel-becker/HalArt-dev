...
use Drupal\av_l_default\Dev;
use Drupal\av_l_default\Helper;
use Drupal\av_l_sections_system\OptionsSetup;

class SectionSystem1x100Options extends LayoutDefault implements PluginFormInterface 
   {
      ...
      public function buildConfigurationForm(array $form, FormStateInterface $form_state) 
         {
            ...
            #Dev::dump($user_configuration, 'msg');
